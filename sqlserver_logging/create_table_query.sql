...
drop table dm_db_index_usage_stats_dump_full
*/
...
select
  ...
  ,type_desc
  ,sys.dm_db_index_usage_stats.*
into dm_db_index_usage_stats_dump_full
from
  sys.dm_db_partition_stats
left join sys.indexes on sys.dm_db_partition_stats.object_id = sys.indexes.object_id
                      and sys.dm_db_partition_stats.index_id = sys.indexes.index_id
...
--古いデータ削除用
create index IX_dm_db_index_usage_stats_dump_full_collect_date on dm_db_index_usage_stats_dump_full(collect_date)
