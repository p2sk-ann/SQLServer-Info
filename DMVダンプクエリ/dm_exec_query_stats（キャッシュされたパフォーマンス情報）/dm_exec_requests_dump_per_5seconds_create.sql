...
select top (500)
  ...
  ,deq.queue_id
  ,deq.wait_order
into dm_exec_requests_dump_per_5seconds
...
--古いデータ削除用
create index IX_dm_exec_requests_dump_per_5seconds_collect_date on dm_exec_requests_dump_per_5seconds(collect_date)
